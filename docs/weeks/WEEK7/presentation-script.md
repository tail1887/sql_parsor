# WEEK7 학습용 대본·설명 노트 (B+ 인덱스)

> **용도**: 발표·스터디·복습용으로 **내용을 길게** 적어 두었습니다. 실제 발표에서는 섹션을 잘라 시간에 맞게 쓰면 됩니다.  
> **대본 + 풀이를 한 파일로** 보려면 → `[presentation-script-full.md](presentation-script-full.md)` · 난해한 부분만 흐름 순으로 → `[presentation-script-easy.md](presentation-script-easy.md)`  
